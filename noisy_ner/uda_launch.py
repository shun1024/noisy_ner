...
def main(_):
    ...
    args['teacher_dir'] = 'deid-xcloud/results/i2b2_2014/baseline-hpsearch-tfour/to=0.03,eh=100,he=256,dt=0.2,le=0.1'
    ...
    for ratio in ratio_to_epoch:
        parameters = hyper.product([
            ...
            hyper.sweep('unlabel_batch_ratio', [4]),
            hyper.sweep('unlabel_weight', [0.5]),
            hyper.sweep('temperature', [0.85]),
            hyper.sweep('augmentation_strength', [0.1, 0.2]),
